...
namespace QSharp.Common.Evade.Invisibility
{
    ...
    public class InvisibilityEvade : Base
    {
        ...
        public InvisibilityEvade(InvsSpell arg,Dash dashinfo)
        {
            ...
            LoadSpellData();
            InvisibilityEvadeMenu = CommonMenu.Add(new Menu("EvadeTarget", Program.Chinese ? "隐身技能躲避:" : "Stealth Evade" + Player.CharacterName, true));
            {
